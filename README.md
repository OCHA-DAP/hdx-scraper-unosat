# Collector for UNOSAT Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-unosat/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-unosat/actions/workflows/run-python-tests.yaml)
 ...
 **hdx-scraper-unosat** as specified in the parameter
 *user_agent_lookup*.
